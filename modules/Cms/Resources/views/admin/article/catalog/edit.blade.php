    ...
    <div class="col-md-12">
        <div class="portlet light portlet-fit portlet-form bordered ">
        	<div class="portlet-title">
        		<div class="caption"><i class="fa fa-gift"></i>编辑文章类别</div>
        	</div>
			<div class="portlet-body form">
				<form method="post" action="{{ _route('cms:admin.article.catalog.update', $catalog->id) }}" accept-charset="utf-8" class="form-horizontal" role="form">
                    {!! method_field('put') !!}
                    {!! csrf_field() !!}
                    <div class="form-body">
    					...
    					<div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
    								<button type="submit" class="btn blue"><i class="icon-ok"></i> 更新文章类别</button>
                                </div>
                            </div>
                        </div>
					</div>

...
class SystemRepository extends BaseRepository
{
    ...
    /**
     * The SystemOptionModel instance.
     *
     * @var App\Model\SystemOptionModel
     */
    protected $option;
     ...
     *
     * @param  App\Model\SystemLogModel $log
     * @param  App\Model\SystemOptionModel $option
     * @return void
     */
    public function __construct(SystemLogModel $log, SystemOptionModel $option)
    {
        $this->model = $log;
        $this->option = $option;
    }

                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase">我的活动</span>
                                <span class="caption-helper hide">每周统计...</span>
                            </div>
                            <div class="actions">
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                    <label class="btn btn-transparent grey-salsa btn-circle btn-sm active">
                                        <input type="radio" name="options" class="toggle" id="option1">今日
                                    </label>
                                    <label class="btn btn-transparent grey-salsa btn-circle btn-sm">
                                        <input type="radio" name="options" class="toggle" id="option2">本周
                                    </label>
                                    <label class="btn btn-transparent grey-salsa btn-circle btn-sm">
                                        <input type="radio" name="options" class="toggle" id="option2">本月
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <div class="table-scrollable table-scrollable-borderless">
                                <table class="table table-hover table-light">
                                    ...
                                    <tr>
                                        <td class="fit"><img class="user-pic" src="/assets/metronic/pages/media/users/avatar4.jpg"> </td>
                                    ...
                                    <tr>
                                        <td class="fit"><img class="user-pic" src="/assets/metronic/pages/media/users/avatar5.jpg"> </td>
                                    ...
                                    <tr>
                                        <td class="fit"><img class="user-pic" src="/assets/metronic/pages/media/users/avatar6.jpg"> </td>
                                    ...
                                    <tr>
                                        <td class="fit"><img class="user-pic" src="/assets/metronic/pages/media/users/avatar7.jpg"> </td>
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title tabbable-line">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab_1_1" data-toggle="tab"> 系统 </a>
                                </li>
                                <li>
                                    <a href="#tab_1_2" data-toggle="tab"> 活动 </a>
                                </li>
                            </ul>
                        </div>
                        <div class="portlet-body">

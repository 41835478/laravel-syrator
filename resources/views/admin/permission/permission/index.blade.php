    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i>权限列表</div> 
                <div class="actions">
                    <a href="{{ _route('admin:permission.permission.create') }}" class="btn btn-default btn-sm">
                    	<i class="fa fa-plus"></i>
                    	<span>新增</span>
                    </a>
                    <a href="{{ _route('admin:permission.permission.removebatch') }}" class="btn btn-default btn-sm" id="removebatch">
					...
					<tbody>
                        ...
                        <tr class="odd gradeX">
        					...
        					<td style="text-align: center;">        					                            	
                            	<a item-id="{{ $per->id }}" href="{{ _route('admin:permission.permission.show', $per->id) }}" class="btn btn-xs layer_open">
                            		<i class="fa fa-eye"></i>
                            	</a>
                            	<a item-id="{{ $per->id }}" href="{{ _route('admin:permission.permission.edit', $per->id) }}" class="btn btn-xs">
                            		<i class="fa fa-pencil-square-o"></i>
                            	</a>
                            	<a item-id="{{ $per->id }}" href="{{ _route('admin:permission.permission.remove') }}" class="btn btn-xs remove">

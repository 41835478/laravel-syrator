...
<div class="page-container row-fluid">
	...
	<div class="page-content">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					<h3 class="page-title">管理员角色管理  <small> 系统管理员角色管理</small></h3>
					<ul class="breadcrumb">
						<li>
							<i class="icon-home"></i>
				...
				<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
					<div class="portlet box grey">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								<div class="btn-group">
									<a href="{{ _route('admin:permission.role.create') }}" class="btn"><i class="icon-pencil"></i> 新增</a>
								</div>
							</div>	
						</div>
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-hover" id="syrator_table_permission_role">							
								<thead>
									<tr>
										<th style="width:8px;text-align:center;">
											<input type="checkbox" class="group-checkable" data-set="#syrator_table_permission_role .checkboxes" />
										</th>			
										<th style="">角色名</th>
										<th style="">角色展示名</th>
										<th style="">创建日期</th>
								...
								<tbody>
                                    ...
                                    <tr class="odd gradeX">
                    					...
                    					<td style="text-align: center;">                                        	
                                        	<a data-title="{{ $per->display_name }}" href="{{ _route('admin:permission.role.show', $per->id) }}" role="button" class="layer_open btn btn-danger" style="background: none;padding:3px;">
                                        		<i class="icon-eye-open"></i>
                                        	</a>
                                        	<a href="{{ _route('admin:permission.role.edit', $per->id) }}" role="button" class="btn btn-danger" style="background: none;padding:3px;">
                                        		<i class="icon-edit"></i>
                                        	</a>
...
<script type="text/javascript" src="{{ _asset('assets/js/table-permission-role.js') }}"></script> 

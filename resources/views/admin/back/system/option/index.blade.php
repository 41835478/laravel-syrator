    ...
    <div class="nav-tabs-custom">    
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab_1">
                ...
                <div class="form-group">
                    <label>图片水印 <a href="javascript:void(0);" class="uploadPic" data-id="picture_watermark"><i class="fa fa-fw fa-picture-o" title="上传"></i></a>  <a href="javascript:void(0);" class="previewPic" data-id="picture_watermark"><i class="fa fa-fw fa-eye" title="预览小图"></i></a></label>
            ...
            <div class="tab-pane" id="tab_2">
                <div class="form-group">
                    <label>系统LOGO<a href="javascript:void(0);" class="uploadPic" data-id="system_logo"><i class="fa fa-fw fa-picture-o" title="上传"></i></a>  <a href="javascript:void(0);" class="previewPic" data-id="system_logo"><i class="fa fa-fw fa-eye" title="预览小图"></i></a></label>
                    <input type="text" class="form-control" id="system_logo" name="data[system_logo]" value="{{ $data['system_logo'] }}" placeholder="缩略图地址：如{{ url('') }}/assets/img/syrator_logo.png" readonly="readonly">
                </div>
                <div class="form-group">
                    <label>系统版本号 </label>

...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-tools">
			<a class="btn btn-social btn-twitter" href="{{ site_url('member/group/creat', 'admin') }}"><i class="fa fa-plus"></i> 新增分组</a>
		</div>
	</div>
	<div class="box-body">
		<table id="group_list" class="table table-hover table-bordered">			
			<thead>
				<tr>
					<th width="30px;">编号</th>
					<th>名称</th>
          	...
          	<tbody>
          		...
          		<tr>
                    ...
                    <td>
                    	<a href="{{ _route('admin:member.group.edit', $per->id) }}"><i class="fa fa-fw fa-pencil" title="修改"></i></a>
                    	<a href="{{ _route('admin:member.group.show', $per->id) }}" class="layer_open" data-title="查看" data-width="400"><i class="fa fa-fw fa-link" title="查看"></i></a>

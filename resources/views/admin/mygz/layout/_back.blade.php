@extends('admin.mygz.layout._base')
...
<!--wrapper start-->
    <div class="wrapper">
      ...
      <div class="content-wrapper">
      	...
      	@include('admin.mygz.widgets.mygz-sidebar')
...
@section('afterBody')
    ...
    <script type="text/javascript">
      $(document).ready(function(){
    	  ...
    	  scheme_less_url = '//' + window.location.host;
          for (i=1;i<path_array.length;i++ ) {
        	  if (path_array[i]=='create' || path_array[i]=='destory' || path_array[i]=='edit') {
            	  break;
        	  }
    		  scheme_less_url = scheme_less_url + '/' + path_array[i];        	  
          }
          ...
          $('ul.treeview-menu>li').find('a[href="'+scheme_less_url+'"]').closest('li').parent().addClass('active');  //一级栏目[含二级链接]的上级高亮

          $(function() {
      	    $('#mygz-side-menu').metisMenu();
      	  });

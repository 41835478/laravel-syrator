...
<html>
    <head>
        ...
        <title>SYRATOR - SYRATOR Framework</title>
        ...
        <div class="wrapper">
            ...
            <footer class="main-footer">
                <div class="container">
                    ...
                    <strong>Copyright &copy; 2011-{{ date('Y') }}  <a href="http://www.syrator.com/">{{ trans('syrator.framework_name') }}</a></strong>  (<code>{{ syrator_version() }}</code>)
                </div><!-- /.container -->
            </footer>
        </div><!-- ./wrapper -->
    </body>

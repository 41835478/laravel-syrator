                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="thumb" name="picture" value="{{ old('picture') }}" placeholder="图片地址：如{{ url('') }}/assets/syrator/image/logo.png" readonly="readonly">
                      </div>
                      <div class="form-group">
                        <label>文档上传 <a href="javascript:void(0);" class="uploadFile" data-id="file"><i class="fa fa-fw fa-file-o" title="上传"></i></a></label>
                        <input type="text" class="form-control" id="file" name="document" value="{{ old('document') }}" placeholder="文件地址：如{{ url('') }}/assets/doc/syrator_logo.pdf">
                      </div>
                      <div class="form-group">

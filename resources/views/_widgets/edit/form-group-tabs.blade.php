    			...
    			@foreach ($perGroup['fields'] as $perField)  
                    ...
                    <div class="control-group">
                    	...
                    	<div class="controls">
                            ...
                            @elseif($editStruct[$perField]->type=='datetime' || $editStruct[$perField]->type=='date')
                				<div id="form_datetime_{{$editStruct[$perField]->name}}" class="input-append date form_datetime">
                					<input size="16" type="text" id="{{$editStruct[$perField]->name}}" name="{{$editStruct[$perField]->name}}" value="{{$editStruct[$perField]->value}}" readonly class="input_form_datetime">

...
<div id="setting" class="mui-page">
	...
	<div class="mui-navbar-inner mui-bar mui-bar-nav" style="background: #60D4AB;">
		<h1 class="mui-title" style="color: #ffffff;">施工队</h1>		
	...
	<div class="mui-page-content">	
		<div id="slider" class="mui-slider">
			<div id="sliderSegmentedControl" class="table-sort-by mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
				<a class="mui-control-item mui-active" href="#sortby_default">综合<span class="arrow_up active_up"></span><span class="arrow_down"></span></a>
				<a class="mui-control-item" href="#sortby_price">价格<span class="arrow_up active_up"></span><span class="arrow_down"></span></a>
				<a class="mui-control-item" href="#sortby_sales">销量<span class="arrow_up active_up"></span><span class="arrow_down"></span></a>
				<a class="mui-control-item" href="#filtrate_setting">筛选</a>
			</div>
		</div>
		<div class="mui-scroll-wrapper" style="margin-top: 39px;">
		...
		success:function(data) {
			...
			if(code == "200") {
				...
				for(var i=0; i<d.length; i++) {
					...
					html += '<a href="{{ _asset('mobile/servicer/shigong/show') }}/' + d[i].goods_id + '">';
